...
k = boundary(coordinatesVertices,1); % be careful with the number
...
coordinates(pointsToDelete,:) = [];
elements(elements>points_delete(1)) = elements(elements>pointsToDelete(1)) - 1;
